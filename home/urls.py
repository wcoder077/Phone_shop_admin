...
urlpatterns = [
    ...
    path("brand/<str:brand>/", views.home, name="brand_filter_view"),
    ...
    path(
        "open_phone_details/<int:pk>/",
        views.open_phone_details,
        name="open_phone_details",
    ),
    # Base urls end
    # Purchase
    path("purchase/", views.purchase_view, name="purchase_view"),
    path(
        "purchase/edit_purchase/<int:pk>/",
        views.edit_purchase_view,
        name="edit_purchase_view",
    ),
    path("purchase/add_purchase/", views.add_purchase_view, name="add_purchase_view"),
    path(
        "purchase/delete_purchase/<int:pk>/",
        views.delete_purchase_view,
        name="delete_purchase_view",
    ),
    path(
        "purchase/purchase_details/<int:pk>/",
        views.open_purchase_details_view,
        name="open_purchase_details_view",
    ),
    # Sale
    ...
    path(
        "sale/sale_details/<int:pk>/",
        views.open_sale_details_view,
        name="open_sale_details_view",
    ),
    # Stuff
    ...
    path(
        "stuff/delete_stuff/<int:pk>/",
        views.delete_stuff_view,
        name="delete_stuff_view",
    ),
    path(
        "stuff/open_stuff_details/<int:pk>/",
        views.open_stuff_details_view,
        name="open_stuff_details_view",
    ),
]
if settings.DEBUG:
